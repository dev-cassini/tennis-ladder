        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_auth_identities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_user_auth_identities_users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_auth_identities_Subject",
                table: "user_auth_identities",
                column: "Subject",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_user_auth_identities_UserId",
                table: "user_auth_identities",
                column: "UserId");
